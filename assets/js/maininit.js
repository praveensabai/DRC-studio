/*!-----------------------------------------------------------------
    Name: drc - Game Portal / Store HTML Template
    Version: 1.4.0
    Author: nK
    Website: https://nkdev.info/
    Purchase: https://themeforest.net/item/drc-portal-store-html-gaming-template/17704593?ref=_nK
...
if (typeof window.drc !== 'undefined') {
    window.drc.setOptions(_options.options);
    window.drc.init();
}
